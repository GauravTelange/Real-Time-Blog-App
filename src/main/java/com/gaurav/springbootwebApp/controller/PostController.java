package com.gaurav.springbootwebApp.controller;
...
import com.gaurav.springbootwebApp.util.ROLE;
...
public class PostController {
    ...
    public String posts(Model model){
        ...
        if(com.gaurav.springbootwebApp.util.ROLE.ROLE_ADMIN.name().equals(role)){
